package com.accesa.springboottrainingpetrut.controller;

import com.accesa.springboottrainingpetrut.dto.InternDto;
import com.accesa.springboottrainingpetrut.entity.Intern;
import com.accesa.springboottrainingpetrut.service.InternService;
...
public class InternController {
    ...
    public InternController(InternService internService) {this.internService = internService; }

    @PostMapping
    @ResponseStatus(HttpStatus.CREATED)
    public InternDto save(@RequestBody InternDto internDto) {return internService.save(internDto);}

    @GetMapping
    public List<InternDto> findInterns() {return internService.findAll();}
    ...
    @PutMapping
    public  InternDto update(@RequestBody InternDto internDto) {return internService.save(internDto);}

    @DeleteMapping("/{id}")
    public void deleteById(@PathVariable Long id) {internService.deleteById(id);}
